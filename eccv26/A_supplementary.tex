...
Experiments shown in ~\tabref{tab:scaling} examine the scalability of our motion-aware sparsification by applying it to a slightly larger ViT-Base model(LoRAT~\cite{lin2024loratrack}) and increasing the input resolution from 256×256 to 384×384. This experiment demonstrates the generalizability of our approach to larger models.
